namespace Bkpk
{
    ...
    public class BkpkException : Exception
    {
        ...
        protected BkpkException(System.Runtime.Serialization.SerializationInfo info,
    ...
    public static class BkpkErrors
    {
        ...
        public static string NOT_AUTHENTICATED = "You must authenticate the user before this operation can be used";
